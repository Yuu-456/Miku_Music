...
ALIVE_PIC = "https://telegra.ph/file/de91427fe131a0578cfb4.jpg"
START_PIC = "https://telegra.ph/file/de91427fe131a0578cfb4.jpg"
...
async def start(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_video(video= START_PIC, caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
...
async def help(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_video(video= ALIVE_PIC, caption=f"{HELP_TEXT}", reply_markup=reply_markup)
