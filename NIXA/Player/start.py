...
async def start(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_video(video=f"START_GIF", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
...
async def help(client: Client, message: Message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    await message.reply_video(video=f"ALIVE_GIF", caption=f"{HELP_TEXT}", reply_markup=reply_markup)
